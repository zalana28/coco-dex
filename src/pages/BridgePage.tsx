...
function e2eEstimate(source: SourceChain): NormalizedEstimate {
  return {
    amount: '10',
    providerFee: null, // Standard/SLOW: no CCTP protocol fee (0 USDC)
    forwarderFee: '0.01',
    kitFee: null,
    totalFee: '0.01',
    destinationAmount: source === 'Ethereum_Sepolia' ? '9.99' : '9.99',
