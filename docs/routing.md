...
CocoStablePool V1 has working testnet LP add/remove flows, but it is not yet a smart router source. It remains available only through the Pools page beta flow.
