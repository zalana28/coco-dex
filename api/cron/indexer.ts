  ...
  try {
    ...
    while (fromBlock <= toBlockMax) {
      ...
      for (const log of mintLogs) {
        ...
        const volume = volumeUsdc + volumeEurc * 1.08
        rows.push({
          tx_hash: log.transactionHash!,
          log_index: log.logIndex!,
          block_number: Number(log.blockNumber),
          ...
          amount0_in: String(amount0),
          amount1_in: String(amount1),
          amount0_out: '0',
          amount1_out: '0',
          reserve0: null,
          reserve1: null,
      ...
      for (const log of burnLogs) {
        ...
        rows.push({
          ...
          amount0_in: '0',
          amount1_in: '0',
          amount0_out: String(amount0),
          amount1_out: String(amount1),
          reserve0: null,
          reserve1: null,
          volume_usd: volume,
          fee_usd: 0,
      ...
      // Process Sync events (track latest reserves)
